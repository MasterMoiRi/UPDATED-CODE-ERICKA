...
<body> 
    ...
    <div class="container" id="login-page">
        ...
        <form action="CODE/BACKEND/login.php" method="post">
            ...
            <a href="code\php\forgot.php" style="color: white; font-weight: bold; text-decoration: none;">Forgot password?</a><br>
            
            <div id="guest-login"> 
    <button type="button" onclick="window.location.href='code/php/guest.php'">Continue as Guest</button><br>
    <a href="code/php/rege.php" style="color: white; font-weight: bold; text-decoration: none;">Don't have an account?</a><br>
</div>
